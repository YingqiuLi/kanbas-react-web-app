...
export default function Dashboard() {
  return (
    <div id="wd-dashboard">
      ...
      <div id="wd-dashboard-courses" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '20px' }}>
        {/* Course 1 */}
        ...
        <div className="wd-dashboard-course">
          <Link className="wd-dashboard-course-link" to="/Kanbas/Courses/5678/Home">
            <img src="../images/OOD.jpg" width={200} alt="Java Course" />
            <div>
        ...
        <div className="wd-dashboard-course">
          <Link className="wd-dashboard-course-link" to="/Kanbas/Courses/9101/Home">
            <img src="../images/cyber.jpg" width={200} alt="Cyber Security Course" />
            <div>
        ...
        <div className="wd-dashboard-course">
          <Link className="wd-dashboard-course-link" to="/Kanbas/Courses/1121/Home">
            <img src="../images/system.jpg" width={200} alt="System Security Course" />
            <div>
        ...
        <div className="wd-dashboard-course">
          <Link className="wd-dashboard-course-link" to="/Kanbas/Courses/1121/Home">
            <img src="../images/csharp.jpg" width={200} alt="C#" />
            <div>
              <h5>CS3250 Game Design</h5>
              <p className="wd-dashboard-course-title">Introduction to Game Design</p>
              <button>Go</button>
            </div>
          </Link>
        </div>
