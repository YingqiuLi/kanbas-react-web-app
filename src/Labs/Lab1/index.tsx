    ...
    return (
        <div id="wd-lab1">
            ...
            <div id="wd-p-tag">
                ...
                <p id="wd-p-4">
                This is the fourth paragraph. Wrap each paragraph with the paragraph tag to tell browsers to render the gaps.
                </p>
            </div>
            <div id="wd-lists">
                <h4>List Tags</h4>
            ...
            <div id="wd-lists">
                ...
                My favorite recipe:
                <ol id="wd-strawberry-butter-pancakes">
                    <li>Prepare flour in a bowl.</li>
                    <li>Add a bottle of water.</li>
                    <li>Add butter and sugar.</li>
                    <li>Stir to combine.</li>
                    <li>Add strawberry sauce on top of it.</li>
                    <li>Heat a skillet or griddle.</li>
                    <li>Pour batter onto the skillet.</li>
                </ol>
                ...
                <ul id="wd-my-books">
                    ...
                    <li>Caffee House with No Ways Out</li>
                    <li>Catch-22</li>
                    <li>Flipped</li>
                </ul>
            </div>
            ...
            <div id="wd-images">
                ...
                <br />
                <img id="wd-teslabot" src="/Users/sue_lyq/2024/kanbas-react-web-app/src/Labs/images/teslabot.jpg" height="200px" alt="wd-teslabot"/>
            </div>
            <div id="wd-forms">
                <h4>Form Elements</h4>
