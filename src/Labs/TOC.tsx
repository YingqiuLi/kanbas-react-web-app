...
export default function TOC() {
  ...
  return (
    <ul className="nav nav-pills" id="wd-toc">
      ...
      <li className="nav-item"><a id="wd-github" href="https://github.com/YingqiuLi/kanbas-react-web-app" target="_blank"
          className="nav-link" rel="noreferrer">My GitHub</a></li>
    </ul>
);}
